...
- [Другие особенности](#другие-особенности)
    ...
    - [Переопределение Mapper'а](#переопределение-Mapper'а)
...
- Вам больше не потребуется передавать огромного количество мапперов в ваши классы/функции. Добавьте
  только `Mapster`
